/*
  JS no browser
  Uso do this: Dentro de um método ele aponta para o próprio objeto daquele método. Dentro de uma função ele aponta para o objeto window, que é um objeto global para o navegador
...
(function () {
  ...
  console.log('my function:', myFunction(), myFunction() === window);
  var myObject = {
    myProperty: 1,
    init: function init() {
      return this;
