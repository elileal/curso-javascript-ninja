/*
'use strict': ECMA5 - inserida por conta de alguns problemas. Não deixa que os problemas acontencam. Usa-se sempre no escopo que deve estrito. 
delete server para deletar propriedades de objects
 */
(function () {
    'use strict';
    /*
