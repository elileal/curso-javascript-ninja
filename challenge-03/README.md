...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é Eliabe Leal!'
...
// Agora, apresente-se ;)
pessoa.apresentacao() // 'Olá, eu sou o Eliabe Leal, tenho 30 anos, 1.8, meu peso é 86 e, só hoje, eu já caminhei 10 metros!'
```
