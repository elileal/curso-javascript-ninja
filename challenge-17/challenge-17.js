/**
 * Expressões regulares: serve para manipular strings (texto),  tipo primitivo como int...
 */
(function () {
  'use strict';
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, 'Eliabe Leal'));
  ...
  */
  ...
  // "13 de junho de 1804"
  var regexDate = /([0-2]\d)\sde\s([a-z]{5})\sde\s(\d{4})/g
