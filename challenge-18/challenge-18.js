(function () {
  ...
  */
  ...
  var clearCPF = dirtyCPF.map(cpf => {
    return cleanCPF(cpf);
  });

  console.log(clearCPF[0]);
  console.log(clearCPF[1]);
  console.log(clearCPF[2]);
  console.log(clearCPF[3]);
  ...
  */
  ...
  var formatedCPF = clearCPF.map(cpf => {
    return cpf.replace(/(\d{2,3})/g, function (regex, p1, p2, p3) {
